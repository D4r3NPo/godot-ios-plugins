...
MOD="release_debug" #<release|debug|release_debug>
VERSION="4.0" #<3.0|4.0>
...
for MODULE in "${MODULES[@]}"; do	# Compile static libraries
	...
	# x86_64 Simulator
	scons target=$MOD arch=x86_64 simulator=yes plugin=$MODULE version=$VERSION
	# ARM64 Simulator
	...
	xcodebuild -create-xcframework \
	    ...
	    -library "./bin/lib$MODULE-simulator.$MOD.a" \
